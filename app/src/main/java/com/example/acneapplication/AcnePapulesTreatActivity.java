...
public class AcnePapulesTreatActivity extends AppCompatActivity {
...
//                        break;
                case R.id.nav_history:
                    Intent historyMenuIntent = new Intent(AcnePapulesTreatActivity.this, HistoryMenuActivity.class);
                ...
                case R.id.nav_acne_treatment:
                    Intent AcneTreatmentMenuIntent = new Intent(AcnePapulesTreatActivity.this, AcneTreatmentActivity.class);
...
//                        break;
                case R.id.nav_clinicRecommend:
                    Intent AcneClinicRecommendationtMenuIntent = new Intent(AcnePapulesTreatActivity.this, AcneClinicRecommendationOnGoogleMapActivity.class);
        ...
        String documentID = "acne_papules_treatment_doc";
